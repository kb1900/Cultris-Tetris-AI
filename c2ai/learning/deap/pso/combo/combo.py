    ...
    def run_game(n, render=False):
        ...
        while exit == 1:
            try:
                ...
                combo_time = (
                    combo_time
                    - 0.08914639647649374  # execute move
                    - 0.028502932752664096  # update garbage
                    - 0.061450676715120355  # check game over
                    - (t1 - t0)  # get best move
                )
...
def main():
    ...
    try:
        ...
        # n = [14.759170912212635, 0.7136370026060272, 5.503746171370423, 2.5999546842948797, 12.087340956923217, 4.124296550268729, 7.906410079911426, 2.4781591841349355, 1.9665436161996785, 5.253625090474918,0,0,0]
        ...
        print("")
        modifiers = ["clears", "combo_time", "combo_counter"]

        for index, modifier in enumerate(modifiers):
            print(modifier, ":", "{0:.2f}".format(n[index]))
