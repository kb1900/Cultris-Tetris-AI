...
def is_loggedin():
    ...
    if is_in_room() == False:
        if (
            Classifier.template_match("Images/online1.png") != False
            or Classifier.template_match("Images/online2.png") != False
            or Classifier.template_match("Images/online3.png") != False
            or Classifier.template_match("Images/online4.png") != False
        ):
...
def is_on_homescreen():
    if (
        Classifier.template_match("Images/home1.png") == False
        and Classifier.template_match("Images/home2.png") == False
        and Classifier.template_match("Images/home3.png") == False
        and Classifier.template_match("Images/home4.png") == False
    ):
        return False
    else:
        return True
...
def is_in_room():
    if (
        Classifier.template_match("Images/kb_baby_bot.png") != False
        or Classifier.template_match("Images/os1.png") != False
        or Classifier.template_match("Images/os2.png") != False
    ):
